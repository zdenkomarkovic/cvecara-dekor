...
export default function ProductPageClient({ product }: Props) {
  ...
  const zoomedImageUrl = images[selectedIndex]
                ...
                return (
                  ...
                  >
                    <Image
                      ...
                      fill
                      style={{ objectFit: "cover", opacity: isActive ? 1 : 0.7, transition: "opacity 0.15s" }}
                      sizes="80px"
                    />
                  </button>
                );
            ...
            <>
              <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1.5rem" }}>
                ...
                >
                  ...
                  <span style={{ width: "36px", textAlign: "center", fontSize: "0.95rem" }}>
                    {quantity}
                  </span>
                  <button
